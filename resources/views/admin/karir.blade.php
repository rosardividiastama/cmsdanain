	...
	<div class="content-wrapper">
	  ...
	  <div class="row">
		<!-- Tab links -->
            ...
            <button class="tablinks" onclick="openCity(event, 'tambah')" id="defaultOpen">Tambah Karir</button>
			<button class="tablinks" onclick="openCity(event, 'daftar')">Daftar</button>
			</div>

			<!-- Tab content -->
			<div id="tambah" class="col-lg-12 tabcontent">
                <h3>Tambah FAQ</h3>
                <form action="{{ route('admin.KarirController.store') }}" class="form-image-upload" method="POST" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-md-5">
			...
			<div id="daftar" class="col-lg-12 tabcontent">
                ...
                @foreach ($karirs as $karir)
                    <form action="{{ route('admin.KarirController.edit',$karir->karir_id) }}" class="form-image-upload" method="POST" enctype="multipart/form-data">
                        {!! csrf_field() !!}
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="col-md-5">
